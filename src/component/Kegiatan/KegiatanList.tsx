...
export default function KegiatanList() {
  ...
  const handleEdit = (item: KegiatanDto) => {
    setSelected(item);
    setIsModalOpen(true);
  };
  ...
  const handleDelete = async (kode: string) => {
    ...
    try {
      // encodeURIComponent untuk menghindari masalah path jika kode mengandung karakter khusus
      await apiClient.delete(`/kegiatan/${encodeURIComponent(kode)}`);
